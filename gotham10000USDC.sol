...
/**
Gotham.cash USDC mixer - 10000 USDC pool
...
contract GothamCash10000USDC {
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 10000 USDC from sender to contract
        bool sent = usdc.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDC transfer failed (Make sure you deposit exactly 10000 USDC)");
