...
/**
Gotham.cash USDC mixer - 1000 USDC pool
...
contract GothamCash1000USDC {
    ...
    uint256 public constant MIX_AMOUNT = 1000_000_000_000_000_000_000; // 1000 * 10^18 (18 decimals)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 1000 USDC from sender to contract
        bool sent = usdc.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDC transfer failed (Make sure you deposit exactly 1000 USDC)");
        ...
        // relayer fee
        require(usdc.transfer(DEV_ADDRESS, feeAmount), "Transfer to relayer failed");
    ...
    function withdraw(bytes32 secret, bytes calldata signature) external {
        ...
        // USDC transfer to signer
        require(usdc.transfer(signer, userAmount), "Transfer to user failed");
