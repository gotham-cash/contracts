...
contract GothamCash1USDC {
    ...
    uint256 public constant MIX_AMOUNT = 1_000_000_000_000_000_000; // 1 * 10^18 (18 decimals)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        require(sent, "USDC transfer failed (Make sure you deposit exactly 1 USDC)");
