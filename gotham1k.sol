...
/**
Gotham.cash $GOTHAM mixer - 1k GOTHAM pool
...
contract GothamCash1k {
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 1k GOTHAM from sender to contract
        bool sent = gotham.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "GOTHAM transfer failed (Make sure you deposit exactly 1k GOTHAM)");
