...
/**
Gotham.cash $GOTHAM mixer - 1M GOTHAM pool
...
contract GothamCash1M {
    ...
    uint256 public constant MIX_AMOUNT = 1000000_000_000_000_000_000_000; // 1000000 * 10^18 (18 decimals)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 1M GOTHAM from sender to contract
        bool sent = gotham.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "GOTHAM transfer failed (Make sure you deposit exactly 1M GOTHAM)");
