...
/**
Gotham.cash USDC mixer - 100 USDC pool
...
contract GothamCash100USDC {
    ...
    uint256 public constant MIX_AMOUNT = 100_000_000_000_000_000_000; // 100 * 10^18 (18 decimals)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 100 USDC from sender to contract
        bool sent = usdc.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDC transfer failed (Make sure you deposit exactly 100 USDC)");
