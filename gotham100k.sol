...
/**
Gotham.cash $GOTHAM mixer - 100k GOTHAM pool

https://gotham.cash
https://github.com/gotham-cash
https://x.com/gotham-cash
...
contract GothamCash100k {
    ...
    uint256 public constant MIX_AMOUNT = 100000_000_000_000_000_000_000; // 100000 * 10^18 (18 decimals)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 10000k GOTHAM from sender to contract
        bool sent = gotham.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "GOTHAM transfer failed (Make sure you deposit exactly 100k GOTHAM)");
