...
/**
Gotham.cash USDC mixer - 10 USDC pool
...
contract GothamCash10USDC {
    ...
    uint256 public constant MIX_AMOUNT = 10_000_000_000_000_000_000; // 10 * 10^18 (18 decimals)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 10 USDC from sender to contract
        bool sent = usdc.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDC transfer failed (Make sure you deposit exactly 10 USDC)");
